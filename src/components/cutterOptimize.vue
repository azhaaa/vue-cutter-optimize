<template>
  <div style="display:inline-block;">
    ...
    <button type="button" v-if="!$slots.openImgCutter && !$slots.open && isModal===true" class="btnbg" @click="handleOpen" style="display: inline-block;" ></button>
            ...
            <div ref="dialogMainModalRef" :class="isModal===true?'dialogMainModal':'dialogMain'" :style="'width:'+(isModal===true?boxWidth+32:boxWidth) + 'px'">
              <div class="toolMain">
                ...
                <div ref="toolBox"
                     ...
                     v-on:touchmove="controlBtnMouseMove"
                     v-on:touchend="controlBtnMouseUp"
                     v-on:touchcancel="controlBtnMouseUp"
                     class="toolBox">
                  <!--选取图片-->
                  ...
                  <div v-if="tool==true" v-show="this.drawImg.img && dropImg.active!==true && controlBox.disable==true && toolBox.disable==true" class="dockMain" :style="'background:'+ this.toolBgc" @mouseenter="dropImgOff">
                    ...
                    <div v-if="originalGraph===false" class="dockBtnScrollBar">
                      <div
                              ...
                              @touchmove="scrollBarControlMove"
                              @touchstart="scrollBarControlOn"
                              @touchcancel="scrollBarControlOff"
                              @touchend="scrollBarControlOff"
                  ...
                  <div
                          ...
                          ref="toolBoxControl"
                          v-on:touchstart="toolBoxMouseDown"
                          v-on:touchend="toolBoxMouseUp"
                          v-on:touchmove="toolBoxMouseMove"
                          v-on:touchcancel="toolBoxMouseLeave"
                  ...
                  <canvas class="canvasSelectBox" ref="canvasSelectBox" :width="boxWidth"
                          @touchstart="dropImgOn"
                          @touchend="dropImgOff"
                          @touchmove="dropImgMove"
          ...
          // toolBoxMouseDown
            ...
            toolBoxMouseMove: function (e) {
                ...
                if (this.toolBox.disable === false && this.moveAble===true) {
                    let offsetX = e.changedTouches[0].pageX - this.toolBox.boxMove.start.x;
                    let offsetY = e.changedTouches[0].pageY - this.toolBox.boxMove.start.y;
            ...
            dropImgOn: function (e) {
                ...
                this.dropImg.pageX = e.changedTouches[0].pageX;
                this.dropImg.pageY = e.changedTouches[0].pageY;
            },
            dropImgOff: function () {
                this.dropImg.active = false;
                if(this.onPrintImgTimmer) {
            ...
            dropImgMove: function (e) {
                ...
                if (this.dropImg.active && this.drawImg.img) {
                    let drawImg = {..._this.drawImg};
                    drawImg.x = _this.dropImg.params.x - (_this.dropImg.pageX - e.changedTouches[0].pageX);
                    drawImg.y = _this.dropImg.params.y - (_this.dropImg.pageY - e.changedTouches[0].pageY);
                    _this.$set(_this, 'drawImg', drawImg);
                    _this.printImg();
                    e.stopPropagation();
                }
            ...
            scrollBarControlMove: function (e) {
                if (this.rotateControl.active) {
                    let offsetX = e.changedTouches[0].pageX - this.rotateControl.start.x;
//                let rotate = this.rotateImg.angle/360*100 + offsetX/100*100;
            ...
            scrollBarControlOn: function (e) {
                ...
                this.rotateControl.start.x = e.changedTouches[0].pageX;
                this.rotateControl.start.y = e.changedTouches[0].pageY;
